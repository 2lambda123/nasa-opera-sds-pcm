...
def test_get_burst_id():
    assert get_burst_id(
        "OPERA_L2_RTC-S1_T020-041121-IW1_20231101T013115Z_20231104T041913Z_S1A_30_v1.0") == "t020_041121_iw1"
    assert get_burst_id(
        "OPERA_L2_CSLC-S1_T150-320187-IW3_20240718T232012Z_20240719T192611Z_S1A_VV_v1.1") == "t150_320187_iw3"


def test_get_burst_sensing_datetime():
    assert get_burst_sensing_datetime(
        "OPERA_L2_RTC-S1_T020-041121-IW1_20231101T013115Z_20231104T041913Z_S1A_30_v1.0") == "20231101T013115Z"
    assert get_burst_sensing_datetime(
        "OPERA_L2_CSLC-S1_T150-320187-IW3_20240718T232012Z_20240719T192611Z_S1A_VV_v1.1") == "20240718T232012Z"
...
def test_generate_url_params():
    ...
    # similar to how ops fwd works, we check only for products with temporal time > 30 days ago
...
def test_map_cslc_bursts_to_frames(mocker):
    ...
    assert set(df.loc[0, 'All Possible Bursts']) == {
        "t001_000001_iw1", "t001_000001_iw2", "t001_000002_iw1", "t001_000002_iw2"}

    # Assert that the Matching Bursts column contains the correct matching bursts for frame 1
    assert set(df.loc[0, 'Matching Bursts']) == {
        "t001_000001_iw1", "t001_000001_iw2"}
    ...
    assert set(df.loc[1, 'All Possible Bursts']) == {
        "t001_000003_iw1", "t001_000003_iw2", "t001_000003_iw3"}
