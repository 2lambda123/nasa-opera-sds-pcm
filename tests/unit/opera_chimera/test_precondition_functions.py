...
class TestOperaPreConditionFunctions(unittest.TestCase):
    ...
    def test_get_slc_polarization(self):
        ...
        pge_config = {oc_const.GET_SLC_S1_POLARIZATION: {}}
    ...
    def test_get_slc_s1_dem(self):
        ...
        settings = {"CSLC_S1": {"ANCILLARY_MARGIN": 50}}
    ...
    def test_get_dswx_hls_dem(self):
        ...
        pge_config = {oc_const.GET_DSWX_HLS_DEM: {oc_const.BBOX: []}}
    ...
    def test_get_dswx_s1_static_ancillary_files(self):
        ...
        expected_static_ancillary_products = [
            "algorithm_parameters",
            "mgrs_database_file",
            "mgrs_collection_database_file",
        ]
    ...
    def test_get_dswx_s1_input_filepaths(self):
        ...
        self.assertIn(
            "s3://opera-dev-rs-fwd/dswx_s1/MS_12_17$146",
            rc_params[oc_const.INPUT_FILE_PATHS],
        )
        self.assertIn(
            "s3://opera-dev-rs-fwd/dswx_s1/MS_12_18$147",
            rc_params[oc_const.INPUT_FILE_PATHS],
        )
        self.assertIn(
            "s3://opera-dev-rs-fwd/dswx_s1/MS_12_19$148",
            rc_params[oc_const.INPUT_FILE_PATHS],
        )
    ...
    def test_get_disp_s1_frame_id(self):
        ...
        context = {"product_metadata": {"metadata": {"frame_id": "88"}}}
    ...
    def test_get_disp_s1_troposphere_files(self):
        ...
        settings = {"DISP_S1": {"STRICT_ANCILLARY_USAGE": True}}
        ...
        expected_troposphere_s3_paths = [
            "s3://opera-ancillaries/ecmwf/20231018/D10180000101800001.subset.zz.nc",
        ...
        self.assertIn(
            "One or more expected ECMWF files is missing from opera-ancillaries/ecmwf",
            str(err.exception),
        )
        ...
        self.assertIn(
            "WARNING:opera_pcm:One or more expected ECMWF files is missing from opera-ancillaries/ecmwf",
            logger.output,
        )
        self.assertIn(
            "WARNING:opera_pcm:No Tropospheres files will be included for this DISP-S1 job",
            logger.output,
        )
