...
forward_arguments = [
    ...
    "--start-date=2021-01-24T23:00:00Z",
    "--end-date=2021-01-25T00:00:00Z",
    "--grace-mins=60",
    "--k=4",
    "--m=4",
]
...
def test_reprocessing_by_native_id(caplog):
    ...
    reprocessing_arguments = [
        ...
        "--k=4",
        "--m=4",
        "--native-id=OPERA_L2_CSLC-S1_T027-056778-IW1_20231008T133102Z_20231009T204457Z_S1A_VV_v1.0",
...
def test_historical_query(caplog):
    ...
    hist_arguments = [
        ...
        "--k=4",
        "--m=4",
        "--start-date=2022-07-18T13:02:00Z",
        "--end-date=2022-07-19T13:01:53Z",
        "--frame-id=44044åå",
    ]
