...
disp_burst_map_hist, burst_to_frames, datetime_to_frames = cslc_utils.process_disp_frame_burst_hist(
...
def test_download_batch_id():
    ...
    # Test forward mode
    granule = {'granule_id': 'OPERA_L2_CSLC-S1_T027-056778-IW1_20231008T133102Z_20231009T204457Z_S1A_VV_v1.0',
               'acquisition_cycle': 145, 'burst_id': 'T027-056778-IW1', 'frame_id': 7098}
...
def test_parse_cslc_native_id():
    ...
    burst_id, acquisition_dts, acquisition_cycles, frame_ids = \
        cslc_utils.parse_cslc_native_id(
            "OPERA_L2_CSLC-S1_T158-338083-IW1_20170403T130213Z_20240428T010605Z_S1A_VV_v1.1", burst_to_frames, disp_burst_map_hist)
...
def test_build_ccslc_m_index():
    ...
    assert cslc_utils.build_ccslc_m_index(
        "T027-056778-IW1", 445) == "t027_056778_iw1_445"
...
def test_determine_k_cycle():
    ...
    args = create_parser().parse_args(
        ["query", "-c", "OPERA_L2_CSLC-S1_V1", "--processing-mode=forward", "--use-temporal"])
    ...
    cslc_dependency = CSLCDependency(
        10, 1, disp_burst_map_hist, args, token, cmr, settings)  # m doesn't matter here
...
def test_get_prev_day_indices():
    ...
    cslc_dependency = CSLCDependency(
        10, 1, disp_burst_map_hist, args, token, cmr, settings)  # k and m don't matter here
